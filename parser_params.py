...
def get_params():
    ...
    serialization_methods = ['pickle', 'simplejson', 'picklejson', 'HDF5']
    ...
    intpy_arg_parser.add_argument('-m', 
                                  ...
                                  default='pickle',
                                  choices=serialization_methods,
                                  type=str,
                                  metavar='',
                                  help='IntPy\'s serialization method: choose one of the following options: '+', '.join(serialization_methods))
    ...
    argsp_m = args.serialization_method

    return argsp_v, argsp_no_cache, argsp_m
